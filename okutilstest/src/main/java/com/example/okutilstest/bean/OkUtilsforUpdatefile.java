...
public class OkUtilsforUpdatefile<T> {
    ...
    public OkUtilsforUpdatefile(Context context) {
        if (mOkHttpClient == null) {
            synchronized (OkUtilsforUpdatefile.class) {
                if (mOkHttpClient == null) {
    ...
    public OkUtilsforUpdatefile<T> post() {
        mFormBuilder=new FormBody.Builder();
        return this;
    }

    public OkUtilsforUpdatefile<T> url(String url) {
        mUrl = new StringBuilder(url);
        return this;
    }

    public OkUtilsforUpdatefile<T> addParam(String key, String value) {
    ...
    public OkUtilsforUpdatefile<T> targetClass(Class<T> clazz) {
        mClazz=clazz;
        return this;
    }

    public OkUtilsforUpdatefile<T> addFile(File file) {
